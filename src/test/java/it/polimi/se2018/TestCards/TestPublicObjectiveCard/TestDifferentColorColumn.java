...
import it.polimi.se2018.model.Cards.PublicObjectiveCard.DifferentColorColumn;
...
public class TestDifferentColorColumn {
    ...
    public void testRunPublic() throws InvalidMoveException{
        ...
        try {
            ...
            PublicObjectiveCard publicCard = new PublicObjectiveCard(new DifferentColorColumn());

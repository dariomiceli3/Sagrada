...
import it.polimi.se2018.server.model.Cards.PublicObjectiveCard.ColorVariety;
...
public class TestColorVariety {
    ...
    public void testRunPublic() throws InvalidMoveException{
        ...
        //try {
            ...
            PublicObjectiveCard publicCard = new PublicObjectiveCard(new ColorVariety(), "Color Variety");

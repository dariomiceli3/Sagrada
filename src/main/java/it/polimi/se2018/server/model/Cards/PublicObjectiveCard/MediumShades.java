...
/**
 * Class MediumShades: it represents the public card Medium Shades of the game and its effect
 * @author fadda-miceli-mundo
 */
public class MediumShades implements PublicEffects, Serializable {

...
/**
 * Class ColumnColorVariety: it represents the public card Column Color Variety of the game and its effect
 * @author fadda-miceli-mundo
 */
public class ColumnColorVariety implements PublicEffects, Serializable {
